                ...
                switch (msgType) {
                    ...
                    case "requestValidatePseudonym":
                        ...
                        if (msg.getMessage().equals(this.network.getChat().getUser().getPseudo().getPseudonym())) {
                            System.out.println("Perso : " + this.network.getChat().getUser().getPseudo().getPseudonym() +
                                    "; Distant : " + msg.getMessage());
                            ...
                            try {
                                ...
                                System.out.println("packet à destination de " + packet.getAddress().getHostAddress());
                                server.send(packet2);
